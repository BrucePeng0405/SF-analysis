...
tmp <- subset(all,idents = c("Monocytes"))
Idents(tmp) <- "group"
...
write.csv(es.max, "mast_GSVA_Monocytes_results.csv")

rd1 <- read.csv(file = "mast_GSVA_Carbohydrate metabolic Macrophages_results.csv")
rd2 <- read.csv(file = "mast_GSVA_Chemotaxis Macrophages_results.csv")
rd3 <- read.csv(file = "mast_GSVA_Monocytes_results.csv")
