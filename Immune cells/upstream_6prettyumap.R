...
### Cell type
all$Cell_type <- factor(all$Cell_type, levels = c("B cells","Carbohydrate metabolic Macrophages",
...
#alphabet2 <- c("#AA0DFE", "#3283FE", "#85660D", "#782AB6", "#565656", "#1C8356",
#               "#16FF32", "#F7E1A0")

alphabet2<- c("#4991c1", "#afc2d9", "#c6307c", "#435b95", "#79b99d", "#e69f84", 
         "#89558d","#d0afc4")
