...
all <- subset(all, idents = c("Adhesion Fibroblasts","Adhesion Myofibroblasts",
                              "Cycle Myofibroblasts","Inflammatory Fibroblasts",
                              "Migration Myofibroblasts"))
gc()


### Cell type
CELLS <- c("Adhesion Fibroblasts","Adhesion Myofibroblasts","Cycle Myofibroblasts",
           "Inflammatory Fibroblasts","Migration Myofibroblasts")
...
alphabet2<- c("#e69f84", "#afc2d9", "#c6307c", "#79b99d", "#4991c1")
...
DotPlot(all,feature = c("ATP6","ND3","CYTB","COX3","ND4","COX2","ND5"),
        assay = "RNA",split.by = "group",cols = c("#C6307C","#AFC2D9"))
