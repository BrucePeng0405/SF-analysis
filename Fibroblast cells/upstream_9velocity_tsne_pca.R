...
#全局速率可视化
pdf(file = "velocity_all/B_7D_velocity_tsne.pdf", width = 10, height = 8)
tSNE.velocity.plot(
  rvel,
...
dev.off()
pdf(file = "velocity_all/B_7D_velocity_pca.pdf", width = 10, height = 8)
pca.velocity.plot(
  rvel,
  cell.colors = cell.colors,
  cex = 0.8,
...
#emb <- all@reductions$umap@cell.embeddings
#全局速率可视化
pdf(file = "velocity_all/B_14D_velocity_tsne.pdf", width = 10, height = 8)
tSNE.velocity.plot(
  rvel,
  cell.colors = cell.colors,
  cex = 0.8,
...
dev.off()
pdf(file = "velocity_all/B_14D_velocity_pca.pdf", width = 10, height = 8)
pca.velocity.plot(
  rvel,
  cell.colors = cell.colors,
  cex = 0.8,
...
#emb <- all@reductions$umap@cell.embeddings
#全局速率可视化
pdf(file = "velocity_all/A_14D_velocity_tsne.pdf", width = 10, height = 8)
tSNE.velocity.plot(
  rvel,
  cell.colors = cell.colors,
  cex = 0.8,
...
dev.off()
pdf(file = "velocity_all/A_14D_velocity_pca.pdf", width = 10, height = 8)
pca.velocity.plot(
  rvel,
  cell.colors = cell.colors,
  cex = 0.8,
...
#emb <- all@reductions$umap@cell.embeddings
#全局速率可视化
pdf(file = "velocity_all/A_7D_velocity_tsne.pdf", width = 10, height = 8)
tSNE.velocity.plot(
  rvel,
  cell.colors = cell.colors,
  cex = 0.8,
...
dev.off()
pdf(file = "velocity_all/A_7D_velocity_pca.pdf", width = 10, height = 8)
pca.velocity.plot(
  rvel,
  cell.colors = cell.colors,
  cex = 0.8,
