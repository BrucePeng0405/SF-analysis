...
all <- subset(all, idents = c("Fibro-myofibro-1","Fibro-myofibro-2",
                                 "Fibro-myofibro-3","Fibro-myofibro-4","Fibro-myofibro-5"))
gc()
...
save(all,file="fibro_recluster_4markers_0.2.Rdata")
...
aver_dt <- aver_dt[,c(7,2,5,3,6,1,4)]
...
cols<- c("#AA0DFE", "#3283FE", "#85660D", "#782AB6", "#565656", "#1C8356", "#16FF32")
